...
public partial class IoStoreReader : AbstractAesVfsReader
{
    ...
    internal byte[] DecompressBlock(int blockIndex)
    {
        ...
        var decrypted = DecryptIfEncrypted(compressedBuffer, 0, rawSize, IsEncrypted, Game == GAME_LordOfMysteries || Game == GAME_FragPunk && Path.Contains("global", StringComparison.Ordinal));
